...
exports.chunks = {
    ...
    0x03043003: {
        name: "Common",
        parse: (buffer) => {
            return new CommonParser_1.CommonParser(buffer).TMCommon();
        },
    },
    0x03043004: {
        name: "Version",
    ...
    0x03043005: {
        name: "Community",
        parse: (buffer) => {
            return new XmlParser_1.XmlParser(buffer).TMXml();
        },
    },
    0x03043007: {
        name: "Thumbnail",
        parse: (buffer) => {
            return new ThumbnailParser_1.ThumbnailParser(buffer).TMThumbnail();
        },
    },
    0x03043008: {
        name: "Author",
        parse: (buffer) => {
            return new AuthorParser_1.AuthorParser(buffer).TMAuthor();
        },
    },
    0x0304300d: {
        parse: (buffer) => {
    ...
    0x03043011: {
        parse: (buffer) => {
            const bp = new BodyParser_1.BodyParser(buffer);
            bp.TMNodeReference();
            bp.TMNodeReference();
    ...
    0x0304301f: {
        parse: (buffer) => {
            ...
            const trackParser = new TrackParser_1.TrackParser(buffer);
